...
import com.citic.common.sms.SMSUtils;
...
import com.citic.modules.sys.dao.OfficeDao;
...
public class UserUtils {
	...
	public static User getByLoginName(String loginName){
		Object o=CacheUtils.get(USER_CACHE, USER_CACHE_LOGIN_NAME_ + loginName);
		User user = (User)o;
		if (user == null){
     ...
     * @return
     */
    public static List<Role> getRoleListByCreuntUser(){
        User user = getUser();
        @SuppressWarnings("unchecked")
        List<Role> roleList = (List<Role>)getCache("rolelist_"+user.getId());
        if (roleList == null){
            roleList = roleDao.findRolesByUser(user.getId());
            putCache("rolelist_"+user.getId(), roleList);
        }
        return roleList;
    }
