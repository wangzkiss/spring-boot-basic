...
import com.citic.common.security.Digests;
import com.citic.common.security.shiro.session.SessionDAO;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void updatePasswordById(String id, String loginName, String newPassword) {
		...
		UserUtils.clearCache(user);
		user.setPassword(Encr.encryptPassword(newPassword));
		user.setName(loginName);
		userDao.updateEtlPassword(user);
//		// 清除权限缓存
//		systemRealm.clearAllCachedAuthorizationInfo();
	}
