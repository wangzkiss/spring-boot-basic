...
public class PaginationInterceptor extends BaseInterceptor
{
    ...
    public Object intercept(Invocation invocation) throws Throwable
    {
        ...
        if (page != null && page.getPageSize() != -1)
        {
            ...
            int countFlag = 1;
            if (mappedStatement.getId().contains("JobInstanceDao.findList"))
            {
                countFlag = 2;
            }
            
            //得到总记录数
            page.setCount(SQLHelper.getCount(originalSql,
                    null,
                    mappedStatement,
                    parameterObject,
                    boundSql,
            ...
            String pageSql = SQLHelper.generatePageSql(originalSql,
                    page,
                    DIALECT);
