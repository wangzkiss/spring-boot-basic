 ...
 */
package com.citic.common.config;
...
import com.citic.common.utils.AESUtil;
import com.citic.common.utils.PropertiesLoader;
...
public class Global {
	...
	public static final String ETL_FILENAME = "tospur_etl";
	/**
	 * 显示/隐藏
	 */
	...
	public static String getConfig(String key) {
		...
		if (StringUtils.isEmpty(value)){
		    ...
		    //判断是否为加密值
		    if(value!=null&& value.length()==24 && value.endsWith("=="))
		    {
		        value=AESUtil.decForTD(value);
		    }
		    //map 中存放的都是明文信息
